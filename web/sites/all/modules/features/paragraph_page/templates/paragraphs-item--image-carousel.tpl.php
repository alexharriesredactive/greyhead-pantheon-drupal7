...
<div class="paragraphs-item paragraphs-item--image-carousel <?php print $carousel_container_class ?>">
  <div class="row">
    ...
    <div id="<?php print $carousel_id ?>" class="carousel slide" data-ride="carousel" data-interval="<?php print $slide_time_ms ?>">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <?php foreach ($field_parapg_carousel_slides_keys as $field_parapg_carousel_slide_key): ?>
          ...
          <?php // Get image URLs ?>
          <?php $desktop_image_url = image_style_url($carousel_slide_fieldgroup['field_carousel_slide_img_desktop'][0]['#image_style'], $carousel_slide_fieldgroup['field_carousel_slide_img_desktop'][0]['#item']['uri']) ?>

          <?php $mobile_image_url = image_style_url($carousel_slide_fieldgroup['field_carousel_slide_img_mobile'][0]['#image_style'], $carousel_slide_fieldgroup['field_carousel_slide_img_mobile'][0]['#item']['uri']) ?>

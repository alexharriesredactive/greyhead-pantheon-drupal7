...
<div class="paragraphs-item paragraphs-item--child-pages-listing container">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php if ($child_pages_list = greyhead_customisations_get_child_pages()): ?>
        <?php print theme('greyhead_customisations_child_pages', ['child_pages_list' => $child_pages_list]) ?>
